/*
 * machine.h - illumos definitions for lsof
 */
 ...
 * file.
 * CAUTION!!!  Do not enable HASDCACHE for /proc-based illumos lsof.  The source
 ...
 *
 * If a special definition is required (e.g., for illumos) before #include'ing
